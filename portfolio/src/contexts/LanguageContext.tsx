...
const translations = {
  vi: {
    ...
    'about.careerGoals.description': 'Sứ mệnh của tôi là kết hợp nghiên cứu học thuật với ứng dụng thực tiễn. Tôi luôn tìm kiếm những phương pháp AI mới và áp dụng chúng để tạo ra các sản phẩm có giá trị, giải quyết các vấn đề thực tế của xã hội.',
    'about.passion.title': 'Động lực',
    'about.passion.description': 'Tôi tin rằng công nghệ phải phục vụ con người. Động lực của tôi đến từ mong muốn đóng góp giá trị cho cộng đồng. Với Capybara, tôi hy vọng giúp mọi người học tập hiệu quả hơn trong thời đại số. Nghiên cứu khoa học là cách tôi phát triển bản thân và đóng góp vào tri thức chung.',
    ...
    'hero.alias': 'alias: ',
    'hero.description': 'Tôi là Kỹ sư Nghiên cứu AI và Nhà phát triển Full-stack. Tôi đam mê xây dựng các giải pháp công nghệ tiên tiến, từ nghiên cứu lý thuyết đến sản phẩm thực tế. Hiện tại, tôi đang tập trung phát triển Capybara - một nền tảng học tập thông minh.',
    'hero.cta': 'Khám phá dự án',
    'hero.typing.1': 'Kỹ sư Nghiên cứu AI',
    'hero.typing.2': 'Doanh nhân công nghệ',
    'hero.typing.3': 'Xây dựng tương lai EdTech',
    'hero.typing.4': 'Đam mê giải quyết vấn đề',
    'hero.typing.5': 'Nhà phát triển Full-stack',
  ...
  en: {
    ...
    'about.careerGoals.description': 'My mission is to combine academic research with practical application. I strive to discover new AI methodologies and apply them to create impactful products that solve real-world problems.',
    'about.passion.title': 'Motivation',
    'about.passion.description': 'I believe technology should serve humanity. My motivation comes from a desire to contribute value to the community. With Capybara, I aim to help people learn more effectively in the digital age. Research is my path to personal growth and contributing to collective knowledge.',
    ...
    'hero.alias': 'alias: ',
    'hero.description': 'I am an AI Research Engineer and Full-stack Developer. I bridge the gap between academic research and practical application, building intelligent systems that solve real-world problems. Currently building Capybara to redefine learning.',
    'hero.cta': 'Explore Projects',
    'hero.typing.1': 'AI Research Engineer',
    'hero.typing.2': 'Tech Entrepreneur',
    'hero.typing.3': 'Building the future of EdTech',
    'hero.typing.4': 'Problem Solver',
    'hero.typing.5': 'Full-stack Developer',
